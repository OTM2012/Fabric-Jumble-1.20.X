...
public class JumblePlacedFeatures {

    //Celestium
    public static final RegistryKey<PlacedFeature> END_CELESTIUM_ORE_PLACED_KEY = registerKey("end_celestium_ore_placed");
    ...
    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(Jumble.MOD_ID, name));
    }
