...
public enum JumbleArmorMaterials implements ArmorMaterial {
    ...
    JumbleArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantability, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
    ...
    public String getName() {
        return Jumble.MOD_ID + ":" + this.name;
    }
